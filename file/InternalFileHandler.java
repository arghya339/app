...
import com.offlinew.android.utils.OtherUtils;

public class InternalFileHandler {
    private static final String TAG = "ifh";
    Context context;
    final String[] directories={"profile",      // store channel/profile information
                                "download",     // store downloaded content
                                "post",         // store all host's post
                                "download_temp",// store current downloading content
                                "send_temp",    // store zipped file ready to send
                                "post_temp",    // create new post and save drafts
                                "chat",         // store chat related files
                                "thumbnail",    // thumbnails
                                "ads",          // to store ads
                                "channel",      // channel related files like picture
                                "posting",      // to store post data while processing
                                "chat_temp",    //
                                "deleted",      // to store deleted stuffs i.e. metaFiles of deleted posts
                                "vid_cat",      // to store video category
                                "others"         // to store other files like voicenotes
                                };
    public final String DIR_PROFILE_PRV = "profile_prv";
    public final String DIR_PROFILE = directories[0];
    public final String DIR_DOWNLOAD = directories[1];
    public final String DIR_POST = directories[2];
    public final String DIR_DOWNLOAD_TEMP = directories[3];
    public final String DIR_SEND_TEMP = directories[4];
    public final String DIR_POST_TEMP = directories[5];
    public final String DIR_CHAT = directories[6];
    public final String DIR_THUMBNAIL = directories[7];
    public final String DIR_ADS = directories[8];
    public final String DIR_CHANNEL = directories[9];
    public final String DIR_POSTING = directories[10];
    public final String DIR_CHAT_TEMP = directories[11];
    public final String DIR_DELETED = directories[12];
    public final String DIR_VID_CATEGORY = directories[13];
    public final String DIR_OTHERS = directories[14];
    ...
    public List<String> getAllInternalVideoFiles(boolean isFullPath){
        List<String> videoFiles = new ArrayList<>();
        videoFiles.addAll(getFolderFilesSpecific("download",isFullPath,".mp4"));
        videoFiles.addAll(getFolderFilesSpecific("post",isFullPath,".mp4"));
        return videoFiles;
    }
    ...
    /**
     * creates subdirectory inside a directory in internal storage
     * if directory not given then subdirectory created in internal storage
     * @param directoryName
...
//    public String getInternalFileChecksum(String subDir,String fileName){
//        File fileToCheck;
//        if(subDir.equals("")){
//            fileToCheck = new File(internalStorageDir,fileName);
//        }else{
...
//
//        try {
//            return ChecksumCalculator.calculateChecksumFileBase64x(fileToCheck, OLConstants.SHA256);
